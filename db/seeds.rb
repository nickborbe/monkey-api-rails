...
social_order: "monogamy, polygyny, and polyandry - cooperative in raising offspring", lifespan: "12 Years", genus: "Callithrix", seeded?: true, family: "Callitrichidae")
...
social_order: "Groups of 3-40 members, composed of one, or several families.  The adult males, subadults, and juveniles in the group assist with caring for the young.", lifespan: "15 years", genus: "Saguinus", seeded?: true, family: "Callitrichidae")
...
social_order: "Multi-male/multi-female groups with up to 500 members", lifespan: "15-20 years", genus: "Saimiri", seeded?: true, family: "Cebidae")
...
social_order: "Groups of 10 to 35 individuals.  Usually 1 dominant male, some Capuchin species have 1 dominant female as well.", lifespan: "22 years", genus: "Cebus", seeded?: true, family: "Cebidae")
...
social_order: "Groups of six to 15 animals, with one to three adult males and multiple females", lifespan: "15-20 years", genus: "Alouatta", seeded?: true, family: "Atelidae")
...
social_order: "Night monkeys live in family groups consisting of a mated pair and their immature offspring. Family groups defend territories by vocal calls and scent marking", lifespan: "20 years", genus: "Aotus", seeded?: true, family: "Aotidae")
...
social_order: "Most baboons live in hierarchical troops. Group sizes vary between five and 250 animals (often about 50 or so), depending on specific circumstances, especially species and time of year.", lifespan: "35-45 years", genus: "Papio", seeded?: true, family: "Cercopithecinae")
