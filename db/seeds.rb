...
social_order: "monogamy, polygyny, and polyandry - cooperative in raising offspring", lifespan: "12 Years", genus: "Callithrix", seeded?: true, sub_family: "Callitrichidae")
...
social_order: "Groups of 3-40 members, composed of one, or several families.  The adult males, subadults, and juveniles in the group assist with caring for the young.", lifespan: "15 years", genus: "Saguinus", seeded?: true, sub_family: "Callitrichidae")
...
social_order: "Multi-male/multi-female groups with up to 500 members", lifespan: "15-20 years", genus: "Saimiri", seeded?: true, sub_family: "Cebidae")
...
social_order: "Groups of 10 to 35 individuals.  Usually 1 dominant male, some Capuchin species have 1 dominant female as well.", lifespan: "22 years", genus: "Cebus", seeded?: true, sub_family: "Cebidae")
...
social_order: "Groups of six to 15 animals, with one to three adult males and multiple females", lifespan: "15-20 years", genus: "Alouatta", seeded?: true, sub_family: "Atelidae")
...
social_order: "Night monkeys live in family groups consisting of a mated pair and their immature offspring. Family groups defend territories by vocal calls and scent marking", lifespan: "20 years", genus: "Aotus", seeded?: true, sub_family: "Aotidae")
...
social_order: "Most baboons live in hierarchical troops. Group sizes vary between five and 250 animals (often about 50 or so), depending on specific circumstances, especially species and time of year.", lifespan: "35-45 years", genus: "Papio", seeded?: true, sub_family: "Cercopithecinae")

ApiMonkey.create(name: "Mandrill", height: "2 ft", weight: "40-90 lbs",
locations_of_origin: "Southern Cameroon, Gabon, Equatorial Guinea, and Congo", diet: "A typical Mandrill's diet is composed of fruit (50.7%), seeds (26.0%), leaves (8.2%), pith (6.8%), flowers (2.7%), and animal-derived foods (4.1%), with other foods making up the remaining (1.4%)."
...
social_order: "With most guenons, related females stay with each other throughout their lives; a daughter’s social status depends on her mother’s ranking in the group. Males leave their family to join a different group when they reach maturity.", lifespan: "15-20 years", genus: "Cercopithecus", seeded?: true, sub_family: "Cercopithecinae")
...
social_order: "Macaques live in large, multi-male/multi-female groups that have an average of 10 to 80 individuals, regardless of habitat type. Groups may number in the hundreds in mountainous areas and areas of high human food subsidization or agricultural habitats. Rhesus macqque groups are characterized by female philopatry and male dispersal; females remain in their natal groups and form dominance hierarchies according to their matrilineal kinship while males emigrate from their natal groups at the beginning of the breeding season shortly before puberty, and may transfer groups throughout their lives in search of mating opportunities. Female rhesus macaques very rarely leave their natal groups.", lifespan: "20 years", genus: "Macaca", seeded?: true, sub_family: "Cercopithecinae")
